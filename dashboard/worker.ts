...
import { unifiedReviewHtml, unifiedReviewStatus } from "./unified-review-dashboard.ts";
...
export default {
  async fetch(request: Request, env: DashboardEnv = {}, ctx?: DashboardContext) {
    ...
    if (url.pathname === "/reviews") return html(unifiedReviewHtml());
    if (url.pathname === "/" || url.pathname === "/index.html")
      return html(env.DASHBOARD_HOME === "reviews" ? unifiedReviewHtml() : dashboardHtml(env));
